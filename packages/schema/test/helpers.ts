...
import { formatVocabulary, validationVocabulary } from "../src/keywords/vocabulary.js";

/**
 * Compile a schema with the default (validation + format) vocabularies and
...
export function compile(
  ...
  return compileSchema(schema, {
    vocabularies: [validationVocabulary, formatVocabulary],
    ...overrides,
  });
}
